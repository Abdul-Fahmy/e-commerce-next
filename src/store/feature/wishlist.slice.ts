...
export const addProductToWishList = createAsyncThunk('wishList/addProductToWishList', async ({productId, token}:{productId:string, token:string})=>{
const options = {
...
export const getWishListInfo = createAsyncThunk('wishList/getWishListInfo', async (token:string)=>{
const options = {
    url :`https://ecommerce.routemisr.com/api/v1/wishlist`,
    method: "GET",
    headers:{
...
console.log({state,action});
if (action.payload.message === "Product removed successfully to your wishlist"

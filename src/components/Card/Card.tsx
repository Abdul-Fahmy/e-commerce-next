    ...
    <>
      <div className="card group/card  shadow-lg overflow-hidden rounded-xl">
        <div className="relative">
          <Image style={{objectFit:'contain', width:'100%',}} width={90} height={60}  src={productInfo.imageCover} priority alt="" />
        ...
        <div className="card-body space-y-2 px-3 py-2">
          ...
          <p className="text-green-400 text-sm line-clamp-2">{productInfo.description}</p>
